...
export class InicioComponent implements OnInit {
  ...
  articulos = [
    ...
    {codigo: 4, descripcion: "computadora", precio: 70},
    {codigo: 5, descripcion: "cama", precio: 69},
...
// DADOS
  ...
  mensaje: string = '';
  imagenURL: string = '';  // Propiedad para la imagen
  ...
  comprobarGanador() {
    ...
    if (valor1 === valor2 || valor1 === valor3 || valor2 === valor3) {
      // Asignar URL de imagen en lugar de texto
      this.imagenURL = 'https://cdn5.dibujos.net/dibujos/pintados/201620/felicidades-felicitaciones-10615904.jpg';
      this.mensaje = '';  // Vaciar el mensaje de texto
    } else {
      this.imagenURL = '';  // Vaciar la URL si no se gana
      this.mensaje = '';
    }
  }
...
ngOnInit():void{
  this.perroService.addPerros('bobi','Bulldog')
  this.perroService.addPerros('zeus','Pitbull')
  this.perroService.addPerros('Suco','Dalmata')
